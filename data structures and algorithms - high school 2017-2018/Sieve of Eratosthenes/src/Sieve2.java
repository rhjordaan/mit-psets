...
/**
 * Sieve2 class - Using an ArrayDeque, calculates the prime numbers up to a certain n and reports the results
 * I found that the ArrayDeque is more efficient than the LinkedList
 * @author Richter Jordaan
 * @version February 11, 2018
 *
 */
public class Sieve2{
	private ArrayDeque<Integer> nums;
	private ArrayDeque<Integer> primeNums;
	boolean callMade;
	int lastN;
	...
	public Sieve2()
	{
		...
		primeNums = new ArrayDeque<Integer>();
		callMade = false;
		lastN = 0;
	}
