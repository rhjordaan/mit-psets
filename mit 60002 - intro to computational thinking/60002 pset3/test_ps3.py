...
class ps3_P1A(unittest.TestCase):
    ...
    def test_room_dirt_dirty(self):
        ...
        room = ps3.BasicRoom(width, height, dirt_amount)
    ...
    def test_get_num_tiles(self):
        ...
        for i in range(11):
            ...
            room_num_tiles = ps3.BasicRoom(width, height, dirt_amount).get_num_tiles()
...
class ps3_P1B(unittest.TestCase):
    ...
    def test_getset_robot_direction(self):
        ...
        # instantiate BasicRoom from solutions for testing
        width, height, dirt_amount = (3, 4, 2)
        solution_room = ps3.BasicRoom(width, height, dirt_amount)
...
class ps3_P3(unittest.TestCase):
    """This  tests BasicRoom and Classic robot in various ways"""
    def createRoomAndRobots(self, num_robots):
        r = ps3.BasicRoom(5, 7, 1)
        robots = [ps3.ClassicRobot(r, 1.0, 1) for i in range(num_robots)]
        return r, robots

    def test_BoundaryConditions(self):
        "Test strict inequalities in random positions for the BasicRoom and ClassicRobot"
        for m in range(7000):
    ...
    def test_update_position_and_cleanClassicRobot(self):
        "Test ClassicRobot.update_position_and_clean"
        r = ps3.BasicRoom(3, 5, 1)
        robot = ps3.ClassicRobot(r, 1.0, 1)
...
"""The SIMULATION_TIME_LIMIT, SimulationThread class and SimulationTester class
    ...
    and passes the tests for ClassicRobot and BasicRoom, there should not be any
    additional issue.
"""
...
class ps3_P5_Classic(SimulationTester):
    """test the simulation time cleaning the BasicRoom with a ClassicRobot"""
    def testSimulation1(self):
        "Test cleaning 100% of a 5x5 room"
        try:
            self.run_simulation(((142, 174),), (1, 1.0, 1, 5, 5, 1, 1.0, 100, ps3.ClassicRobot))
        except:
            print ("Unexpected error:", sys.exc_info()[1])
            raise
    def testSimulation2(self):
        "Test cleaning 75% of a 10x10 room (Classic Robot)"
        self.run_simulation(((183, 198),), (1, 1.0, 1, 10, 10, 1, 0.75, 100, ps3.ClassicRobot))
    def testSimulation3(self):
        "Test cleaning 90% of a 10x10 room (Classic Robot)"
        self.run_simulation(((298, 327),), (1, 1.0, 1, 10, 10, 1, 0.9, 100, ps3.ClassicRobot))
    def testSimulation4(self):
        "Test multiple robots (95% of a 20x20 room with 5 robots (Classic Robot))"
        self.run_simulation(((289, 303),), (5, 1.0, 1, 20, 20, 1, 0.95, 100, ps3.ClassicRobot))
    def testSimulation5(self):
        "Test different speeds (90% of a 5x20 room with a robot of speed 0.2 (Classic Robot))"
        self.run_simulation(((1095, 1228),), (1, 0.2, 1, 5, 20, 1, 0.9, 100, ps3.ClassicRobot))
    def testSimulation6(self):
        "Test multiple robots and different speeds (90% of a 10x10 room with 3 robots of speed 0.5 (Classic Robot))"
        self.run_simulation(((155, 180),), (3, 0.5, 1, 10, 10, 1, 0.9, 100, ps3.ClassicRobot))
    # new tests below here
    def testSimulation7(self):
         "Test cleaning 100% of a 5x5 room (Classic Robot, 5 dirt/tile, capcity = 3)"
         self.run_simulation(((206, 266),(180, 240)), (1, 1.0, 3, 5, 5, 5, 1.0, 100, ps3.ClassicRobot))
    def testSimulation8(self):
        "Test cleaning 100% of a 5x5 room (Classic Robot, 6 dirt/tile, capacity = 3)"
        self.run_simulation(((206, 266),(180, 240)), (1, 1.0, 3, 5, 5, 6, 1.0, 100, ps3.ClassicRobot))
    def testSimulation9(self):
        """Test different speeds (90% of a 3x10 room with a robot of speed 0.2 (Classic Robot)),
        capacity = 2, 6 dirt/tile"""
        self.run_simulation(((387, 447),(384, 444)), (1, 0.2, 2, 3, 10, 6, 0.9, 100, ps3.ClassicRobot))
    def testSimulation10(self):
        "Test multiple robots (95% of a 10x10 room with 5 robots (Classic Robot)) capacity = 2, 6 dirt/tile"
        self.run_simulation(((137, 198),(130, 190)), (5, 1.0, 2, 10, 10, 6, 0.95, 100, ps3.ClassicRobot))
    def testSimulation11(self):
        """Test multiple robots and different speeds (90% of a 5x5 room with 3 robots of speed 0.5
        (Classic Robot)), capacity = 2, 6 dirt/tile"""
        self.run_simulation(((48, 108), (45, 104)), (3, 0.5, 2, 5, 5, 6, 0.9, 100, ps3.ClassicRobot))

class ps3_P5_Malfunctioning(SimulationTester):
    """test the simulation time cleaning the BasicRoom with a MalfunctioningRobot"""
    def testSimulation1(self):
...
class ps3_P5_Better(SimulationTester):
    """test the simulation time cleaning the BasicRoom with a MalfunctioningRobot"""
    def testSimulation1(self):
        "Test cleaning 100% of a 5x5 room with BetterRobot"
        x = ps3.run_simulation(1, 1.0, 1, 5, 5, 1, 1.0, 100, ps3.BetterRobot)
        self.assertTrue(100 <= x <= 175, "Simulation output was outside of 99.7% confidence interval! Took " + str(x) + " steps\n")
    def testSimulation2(self):
        "Test cleaning 75% of a 10x10 room with BetterRobot"
        x = ps3.run_simulation(1, 1.0, 1, 10, 10, 1, 0.75, 100, ps3.BetterRobot)
        self.assertTrue(105 <= x <=125, "Simulation output was outside of 99.7% confidence interval! Took " + str(x) + " steps\n")
    def testSimulation3(self):
        "Test cleaning 90% of a 10x10 room with BetterRobot"
        x = ps3.run_simulation(1, 1.0, 1, 10, 10, 1, 0.9, 100, ps3.BetterRobot)
        self.assertTrue(170 <= x <=210, "Simulation output was outside of 99.7% confidence interval! Took " + str(x) + " steps\n")
    def testSimulation4(self):
        "Test cleaning 100% of a 5x5 room with BetterRobot"
        x = ps3.run_simulation(2, 1.0, 2, 5, 5, 5, 1.0, 100, ps3.BetterRobot)
        self.assertTrue(95 <= x <=125, "Simulation output was outside of 99.7% confidence interval! Took " + str(x) + " steps\n")
    def testSimulation5(self):
        "Test cleaning 75% of a 10x10 room with BetterRobot"
        x = ps3.run_simulation(4, 1.0, 3, 10, 10, 5, 0.75, 100, ps3.BetterRobot)
        self.assertTrue(50 <= x <=57, "Simulation output was outside of 99.7% confidence interval! Took " + str(x) + " steps\n")
    def testSimulation6(self):
        "Test cleaning 90% of a 10x10 room with BetterRobot"
        x = ps3.run_simulation(5, 1.0, 3, 10, 10, 10, 0.9, 100, ps3.BetterRobot)
...
if __name__ == "__main__":
    ...
    suite.addTest(unittest.makeSuite(ps3_P5_Classic))
    suite.addTest(unittest.makeSuite(ps3_P5_Malfunctioning))
    suite.addTest(unittest.makeSuite(ps3_P5_Better))
